...
const Dashboard = () => {
  ...
  return (
    <div className="container-fluid py-3" style={{ backgroundColor: '#f8fafc', minHeight: '100vh' }}>

      {/* 1. Executive Operations Header */}
      <div className="card border shadow-sm rounded-3 p-4 mb-4 bg-white">
        <div className="d-flex flex-column flex-lg-row justify-content-between align-items-start align-items-lg-center gap-3">
          <div>
            <div className="d-flex align-items-center gap-2 mb-2 flex-wrap">
              <span className="badge bg-primary-subtle text-primary fw-bold px-3 py-1 rounded-pill small">
                <i className="bi bi-shield-check me-1"></i> STEM CELL DBMS &amp; REGISTRY
              </span>
            ...
            <h2 className="fw-bold text-dark mb-1" style={{ letterSpacing: '-0.02em' }}>
              Biobank Operations &amp; Clinical Registry
            </h2>
          ...
          <div className="d-flex flex-wrap gap-2 align-items-center">
            ...
            <Link to="/ml-match" className="btn btn-outline-primary btn-sm px-3 d-flex align-items-center gap-1 rounded-pill">
              <i className="bi bi-cpu-fill"></i>
              <span>AI Match</span>
            </Link>
            <Link to="/ocr-reports" className="btn btn-outline-secondary btn-sm px-3 d-flex align-items-center gap-1 rounded-pill">
      ...
      {/* 3. Analytics & Clinical Monitoring Suite */}
                ...
                {filteredPatients.map((p) => (
                  <tr key={p.patient_id}>
                    ...
                    <td>
                      ...
                      <small className="text-muted">Registered in Stem Cell DBMS</small>
                    </td>
                    <td>
              ...
              <tbody>
                ...
                {filteredDonors.length === 0 && (
                  <tr>
                    <td colSpan="7" className="text-center text-muted py-4">
                      <i className="bi bi-inbox fs-3 d-block mb-1 text-secondary"></i>
                      No donors matching current criteria
                    </td>
                  </tr>
                )}
              </tbody>
      ...
      {/* 5. Sleek AI Assistant Diagnostic Quick Bar */}
      <div
        className="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center gap-3 p-3 rounded-4 shadow-sm"
        style={{
      ...
      >
        <div className="d-flex align-items-center gap-3">
          ...
          <div>
            <div className="fw-bold text-white mb-0 d-flex align-items-center gap-2">
              <span>KOSHIKA AI Clinical Assistant</span>
              <span className="badge bg-info-subtle text-info border border-info border-opacity-25" style={{ fontSize: '0.68rem' }}>
                Copilot Ready
              </span>
            </div>
            <p className="text-white-50 small mb-0">
              Need HLA matching analysis, donor search triage, or clinical stem cell protocols?
            </p>
          </div>
        </div>
        ...
        <div className="d-flex flex-wrap gap-2">
          <button
            type="button"
            className="btn btn-outline-light btn-sm rounded-pill py-1 px-3 d-inline-flex align-items-center gap-1"
            style={{ fontSize: '0.78rem', borderColor: 'rgba(255,255,255,0.25)' }}
            onClick={() => handleAskAI('What is the HLA matching process and required compatibility criteria?')}
          >
            <i className="bi bi-cpu"></i>
            <span>HLA Matching Rules</span>
          </button>
          <button
            type="button"
            className="btn btn-outline-light btn-sm rounded-pill py-1 px-3 d-inline-flex align-items-center gap-1"
            style={{ fontSize: '0.78rem', borderColor: 'rgba(255,255,255,0.25)' }}
            onClick={() => handleAskAI('Which donor blood groups are compatible with O+ and AB+ patients?')}
          >
            <i className="bi bi-droplet"></i>
            <span>ABO Compatibility</span>
          </button>
          <button
            type="button"
            className="btn btn-outline-light btn-sm rounded-pill py-1 px-3 d-inline-flex align-items-center gap-1"
            style={{ fontSize: '0.78rem', borderColor: 'rgba(255,255,255,0.25)' }}
            onClick={() => handleAskAI('What are the critical storage standards for liquid nitrogen cryogenic tanks?')}
          >
            <i className="bi bi-snow"></i>
            <span>Cryo Protocols</span>
          </button>
          <button
            type="button"
            className="btn btn-info btn-sm text-white fw-bold rounded-pill py-1 px-3 d-inline-flex align-items-center gap-1"
            style={{ fontSize: '0.78rem', backgroundColor: '#0284c7', borderColor: '#38bdf8' }}
            onClick={() => handleAskAI('')}
          >
