...
SECRET_KEY = SECRET_KEY or 'local-development-only-change-me-use-a-real-secret-in-production'
...
CORS_ALLOW_ALL_ORIGINS = DEBUG and os.getenv('CORS_ALLOW_ALL', 'True').lower() in ('1', 'true', 'yes')
